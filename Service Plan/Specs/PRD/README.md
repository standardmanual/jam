...
> 기준으로 재작성했다. 트라이브·조합·미션·포인트·팔로우·어뷰징·드랍엔진v2·CMS 등
...
| [Inventory/](./Inventory/) | 인벤토리 포화 인지·드랍 순환 유도 |
...
| 영역 | 문서 |
|------|------|
| 배지·드랍 엔진 판정 로직 (드랍엔진 v2, 트라이브 모멘텀, 앰비언트 드랍 등) | [Specs/BadgeEngine/BADGE_ENGINE_UNIFIED.md](BADGE_ENGINE_UNIFIED.md) |
| 액티비티배지·컬렉션·아이템배지·트라이브·POI 컨텐츠 목록 | [Specs/Content/](../Content/) |
...
**Strava 연동 → 배지 자동 발급 → 지도에서 아이템 드랍/픽업 → 트라이브별 컬렉션 완성 → 조합·미션·포인트로 순환 → (예정) 실물 패치 구매 자격**
