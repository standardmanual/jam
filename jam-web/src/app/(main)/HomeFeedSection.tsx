...
function DetailSheet({ item, onClose }: { item: ActivityFeedRow; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-50 ${isMissionCompleted ? 'bg-jam-lime' : 'bg-jam-cream'} border-t-[3px] border-jam-ink rounded-t-3xl px-6 pt-5 pb-[calc(env(safe-area-inset-bottom)+2rem)]`}>
