            ...
            >
              ...
              {isSlotted && !readOnly && (
                <button
                  ...
                  disabled={pending}
                  className="block mx-auto px-3 py-1 text-[11px] leading-none rounded-[var(--radius-pill-buttons)] bg-[color:var(--color-primary)] text-white transition-all disabled:opacity-40"
                >
