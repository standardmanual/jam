...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/badges/bulk', label: '배지 일괄 변경', icon: IconStackPop },
      { href: '/admin/badge-metric-labels', label: '배지 지표 라벨', icon: IconTag },
      { href: '/admin/item-badges', label: '아이템배지 발급현황', icon: IconBarcode },
      { href: '/admin/item-badges/orphaned', label: '미소유 아이템배지', icon: IconUserOff },
      ...
      { href: '/admin/poi', label: '체크인 관리', icon: IconMapPin },
