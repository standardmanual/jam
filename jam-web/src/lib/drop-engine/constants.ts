/**
 * 드랍엔진 v2 — 트라이브 고정 상수 (019_seed_worldview.sql 고정 UUID)
 * 이름이 아닌 id로 식별한다 (이름 변경에 취약하지 않게).
 */

/** 미스터리 헌터 — epic+ 전용 전역 스파이스 */
export const MYSTERY_TRIBE_ID = '24d7af8e-a4ef-8798-a7f1-f1f2d6c9d582'

/** 작심삼일 클럽 — 신규 유저 온보딩 + 복귀 서사 */
export const RESOLUTION_TRIBE_ID = 'e9e608d7-812c-4139-88c4-81d129076e3f'

/** 신규 유저 온보딩(첫 3드랍): 주 활동종목 → 트라이브 매핑 */
export const ONBOARDING_TRIBE_BY_ACTIVITY: Record<string, string> = {
